...
function createFingerprint(input = {}) {
    ...
    return {
        ...
        mediaDevices,
        plugins,
        webglVendor: input.webglVendor || preset.webglVendor || 'Google Inc. (Intel)',
        webglRenderer: input.webglRenderer || preset.webglRenderer || 'ANGLE (Intel, Intel(R) Iris(R) Xe Graphics Direct3D11 vs_5_0 ps_5_0)',
        canvasNoise: Number(input.canvasNoise) || randomInt(1, 99, rng),
        audioNoise: Number(input.audioNoise) || randomInt(1, 99, rng),
    };
}
